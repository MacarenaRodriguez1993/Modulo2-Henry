...
// Tu código acá:
let autor= ' Maca Rodriguez';

//let selectSpan = document.getElementById('createdBy');
let selectSpan = document.querySelector('#createdBy');
selectSpan.innerHTML += autor;
...
function addToDo() {
  ...
  if(input.value != '') {
    var to_Do= new ToDo(input.value);
    toDoItems.push(to_Do);
    input.value='';
    displayToDos();
  }
